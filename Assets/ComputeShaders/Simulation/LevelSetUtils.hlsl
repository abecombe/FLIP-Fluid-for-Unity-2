...
inline void CycleFloat4(inout float4 val) {
...
inline float FractionInside(float phi_left, float phi_right)
{
...
inline float FractionInside(float phibl, float phibr, float phitl, float phitr)
{
    ...
    switch (inside_count)
    {
        ...
        case 3 :
        {
            ...
            while (phi_list[0] < 0) {
                CycleFloat4(phi_list);
            }

            // work out the area of the exterior triangle
            const float side_0 = 1 - FractionInside(phi_list[0], phi_list[3]);
            const float side_1 = 1 - FractionInside(phi_list[0], phi_list[1]);
        ...
        case 2 :
        {
            ...
            if (phi_list[1] < 0)
            {
                ...
                const float side_left = FractionInside(phi_list[0], phi_list[3]);
                const float side_right = FractionInside(phi_list[1], phi_list[2]);
            ...
            else // phi_list[2] < 0
            {
                ...
                if (middle_point < 0)
                {
                    ...
                    const float side_1 = 1 - FractionInside(phi_list[0], phi_list[3]);
                    const float side_3 = 1 - FractionInside(phi_list[2], phi_list[3]);

                    area += 0.5f * side_1 * side_3;

                    // second triangle (top right)
                    const float side_2 = 1 - FractionInside(phi_list[2], phi_list[1]);
                    const float side_0 = 1 - FractionInside(phi_list[0], phi_list[1]);
                ...
                else // middle_point >= 0
                {
                    ...
                    const float side_0 = FractionInside(phi_list[0], phi_list[1]);
                    const float side_1 = FractionInside(phi_list[0], phi_list[3]);
                    area += 0.5f * side_0 * side_1;

                    // second triangle (top right)
                    const float side_2 = FractionInside(phi_list[2], phi_list[1]);
                    const float side_3 = FractionInside(phi_list[2], phi_list[3]);
        ...
        case 1 :
        {
            ...
            const float side_0 = FractionInside(phi_list[0], phi_list[3]);
            const float side_1 = FractionInside(phi_list[0], phi_list[1]);
